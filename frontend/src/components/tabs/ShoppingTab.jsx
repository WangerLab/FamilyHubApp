...
export default function ShoppingTab() {
  ...
  return (
    ...
    >
      ...
      >
        <ShoppingCart className="w-10 h-10 text-slate-300 dark:text-slate-700" strokeWidth={1.5} />
      </div>
      ...
      <div className="space-y-2">
        ...
        <p className="text-base text-slate-500 dark:text-slate-400 max-w-xs">
          Your shared grocery list will live here. Add items and tick them off as you shop.
        </p>
      </div>
